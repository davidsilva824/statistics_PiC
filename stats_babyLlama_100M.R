...
# Load data
dat <- read.csv("results_experiment_1_babyLlama_100M.csv", check.names = TRUE)
...
# DO NOT set contrasts() manually (leave default treatment)

# numeric coding for || random slopes (0 = reference, 1 = other)

...
ggemmeans(m_freq, c("plurality", "regularity")) |> plot()
...
m <- brm(Surprisal.head ~ 1 + regularity / plurality +
         ...
         cores = 4,
         backend = "cmdstanr",
         file = "C:/Users/Admin/Desktop/Dissertação/código/satistics_PiC/Statistics_PiC/Bayesean_Statistics/surprisal_gaussian_nested_experiment_1_10M")
...
(hyp_reg <- hypothesis(m, "regularityRegular:plurality1 = 0"))
log(1 / hyp_reg$hypothesis$Evid.Ratio)

(hyp_irreg <- hypothesis(m, "regularityIrregular:plurality1 = 0"))
log(1 / hyp_irreg$hypothesis$Evid.Ratio)

(hyp_int <- hypothesis(m, "regularityRegular:plurality1 - regularityIrregular:plurality1 = 0"))
log(1 / hyp_int$hypothesis$Evid.Ratio)

(m_eff_reg <- hypothesis(m, "regularityRegular:plurality1 > 0", scope = "coef", group = "model", alpha = 0.025)$hypothesis)
(m_eff_irreg <- hypothesis(m, "regularityIrregular:plurality1 > 0", scope = "coef", group = "model", alpha = 0.025)$hypothesis)
(m_eff_int <- hypothesis(m, "regularityRegular:plurality1 - regularityIrregular:plurality1 > 0",

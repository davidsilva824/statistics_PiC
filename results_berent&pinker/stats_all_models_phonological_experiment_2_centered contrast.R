...
setwd("C:/Users/Admin/Desktop/Dissertação/código/satistics_PiC/Statistics_PiC/results_phonological_compounds/experiment_2/all_results")

# Get list of all CSV files for THIS experiment in the folder
file_list <- list.files(pattern = "^results_experiment_2_.*\\.csv$", ignore.case = TRUE)

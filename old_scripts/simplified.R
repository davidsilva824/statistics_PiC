...
# Load data
dat <- read.csv("results_experiment_3_babyLlama_10M.csv", check.names = TRUE)
...
### optionally print(all_results) to check if it is working well on the inside. 
